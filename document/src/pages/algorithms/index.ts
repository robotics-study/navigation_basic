...
const data: IAlgoData[] = [
    ...
    },
    {
        ...
        sections: [
            ...
            {en: "The Open-Field Zigzag", ko: "개활지 지그재그"},
            {en: "Demo", ko: "Demo"},
            {en: "Implementation", ko: "Implementation"},
            {en: "References", ko: "References"},
        ],
    ...
    {
        slug: "elastic_bands",
        title: {en: "Elastic Bands", ko: "Elastic Bands"},
        category: "local",
        supportedExample: {python: true, "c++": true},
        contents: lazy(() => import("./local/ElasticBands")),
        sections: [
            {en: "Bubbles and the Band", ko: "버블과 밴드"},
            {en: "Forces on the Band", ko: "밴드에 작용하는 힘"},
            {en: "Properties and Complexity", ko: "성질과 복잡도"},
            {en: "The Algorithm", ko: "알고리즘"},
            {en: "The Symmetry Stall", ko: "대칭 정체"},
            {en: "Demo", ko: "Demo"},
            {en: "Implementation", ko: "Implementation"},
            {en: "References", ko: "References"},
        ],
    ...
    {
        slug: "teb",
        title: {en: "Timed Elastic Band", ko: "Timed Elastic Band"},
        category: "local",
        supportedExample: {python: true, "c++": true},
        contents: lazy(() => import("./local/Teb")),
        sections: [
            {en: "Adding Time to the Band", ko: "밴드에 시간을 더하다"},
            {en: "Cost Terms", ko: "비용 항"},
            {en: "Properties and Complexity", ko: "성질과 복잡도"},
            {en: "The Algorithm", ko: "알고리즘"},
            {en: "The Homotopy Trap", ko: "Homotopy 함정"},
            {en: "Demo", ko: "Demo"},
            {en: "Implementation", ko: "Implementation"},
            {en: "References", ko: "References"},
        ],
    },
    {
        ...
        category: "local",
        supportedExample: {python: true, "c++": true},
        contents: lazy(() => import("./local/Mpc")),
        sections: [
            {en: "From Poses to Controls", ko: "pose에서 control로"},
            {en: "The Receding-Horizon Cost", ko: "Horizon을 따라가는 비용"},
            {en: "Properties and Complexity", ko: "성질과 복잡도"},
            {en: "The Algorithm", ko: "알고리즘"},
