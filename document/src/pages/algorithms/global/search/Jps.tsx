    ...
    return (
        <>
            <T
                ...
                ko={<p>
                    열린 grid에서 A* 확장의 대부분은 낭비다. 두 점 사이에는 같은 이동들의
            ...
            <T
                ...
                ko={<>
                    <p>
                        ...
                        grid에서 그런 일은 장애물 모서리 옆에서만 생긴다. 그 셀들이{" "}
                    ...
                    <p>
                        ...
                        마다 두 직교 방향을 찔러 보고, 어느 쪽이든 jump point를 찾으면 자신이
                        jump point가 된다.
                    </p>
                </>}
            />
            ...
            <T
                ...
                ko={<ul>
                    ...
                    <li><strong>전처리도 추가 메모리도 없다.</strong> 전부 질의 시점의 단일 셀
                        점유 oracle에서 유도되므로, 질의 사이에 바뀌는 맵에서도 동작한다.</li>
                    <li><strong>확장 수가 무너지듯 준다.</strong> 스캔이 셀을 훑긴 하지만 셀
                        probe는 큐 삽입보다 훨씬 싸다. 최악의 경우(빽빽한 장애물)에는 A* 수준으로
                        퇴화한다.</li>
    ...
    return none                                               # dead end`}/>
            ...
            <T
                ...
                ko={<p>
                    ...
                    셀이고, 남색 점이 JPS의 확장이며, 길게 뻗은 트리 선이 장애물 모서리에 바로
                    내려앉는 jump다. 장애물을 더 그리면 두 수치가 가까워진다. 빽빽한 맵에
                    없는 것이 바로 대칭이다.
                </p>}
            />
            <JpsSandbox/>
            <TraceReplay algo="jps" maps={["open01", "maze01"]} label={t(
                ...
                "저장소 JPS demo의 실제 trace. A*가 수백 번 확장하던 곳을 몇 번으로 끝낸다",
            )}/>
            ...
            <T
                ...
                ko={<p>
                    ...
                    아래에 embed 했다. successor edge가 단위 스텝이 아니라 jump 전체의 octile
                    비용을 실어 나르는 점을 눈여겨보라.
                </p>}
            />
            <CodeTabs
