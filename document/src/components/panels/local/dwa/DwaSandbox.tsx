...
// "clutter" 프리셋: 저장소 실제 demo 맵(maps/grid/clutter01.pgm)을 그대로 재사용한다 --
// PF/VFH sandbox와 같은 관례(손으로 새 지형을 지어 균형을 잘못 잡을 위험 없음).
type Rows = string[];
            ...
            footer={
                <div className="flex flex-col items-center gap-1.5">
                    ...
                    <div className="text-xs text-muted text-center tabular-nums">
                        {t(
                            "walk through the wall gap, weave the clutter, or watch the dead end stop the robot honestly",
